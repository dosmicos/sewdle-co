  ...
  return (
    <div className="p-6 space-y-8 animate-fade-in">
      <div className="flex items-center justify-between text-gray-800">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-black">Entregas</h1>
          <p className="text-gray-600">Gestión de entregas y recepciones</p>
        </div>
      ...
      <Card className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold mb-2 text-black">No hay entregas registradas</h3>
          <p className="text-gray-600 mb-4">Las entregas de los talleres aparecerán aquí</p>
          <Button className="bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-xl px-6 py-3 transition-all duration-200 active:scale-[0.98]">
            <Plus className="w-4 h-4 mr-2" />
            Registrar Entrega
          </Button>
