        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 lg:py-24">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4 max-w-4xl mx-auto">
              <h1 className="text-4xl font-bold text-gray-900 leading-tight lg:text-6xl">
                Toma el control total de tu
                <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent font-semibold text-5xl">
                  {" "}producción textil
                </span>
              </h1>
