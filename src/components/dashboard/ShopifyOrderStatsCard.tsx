...
import { Package, PackageCheck, TrendingUp, TrendingDown, Minus, Clock, Zap, Timer, BarChart3, Activity } from 'lucide-react';
          ...
          <TabsContent value="productividad" className="space-y-6">
            ...
            {filteredHourlyStats.length > 0 ? (
              ...
              <div className="text-center py-6 text-gray-500">
                ...
                <p>No hay datos de productividad en este período</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="tendencia" className="space-y-4">
            {stats.dailyStats.length > 1 ? (
              ...
              <div className="text-center py-6 text-gray-500">
                ...
                <p>Selecciona un rango mayor para ver la tendencia diaria</p>
              </div>
            )}
          </TabsContent>
        </Tabs>
