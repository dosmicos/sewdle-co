...
import { LayoutDashboard, FileText, Building2, Package, Truck, LogOut, User, Users, Package2, Palette, Shield, DollarSign, Brain, TrendingUp, ShoppingCart, Settings, ChevronDown, Target, UserPlus, Calculator, PackageSearch, Receipt, MessageSquare, Wifi, Camera, Megaphone, CalendarRange } from 'lucide-react';
