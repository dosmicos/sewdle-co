...
const workspaceItems: NavItem[] = [
  ...
  { label: 'Voz del Cliente', icon: <MessageCircle className="h-4 w-4" />, id: 'customer-voice', path: '/customer-voice' },
...
const FinanceSidebar: React.FC<FinanceSidebarProps> = ({
  ...
  const currentSection = activeSection ?? (() => {
    ...
    if (location.pathname === '/customer-voice') return 'customer-voice';
