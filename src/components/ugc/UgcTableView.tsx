...
export const UgcTableView: React.FC<UgcTableViewProps> = ({
  ...
  // Stage 1: apply all filters EXCEPT tag → used for adaptive tag chip counts
  // Stage 2: apply tag filter on top of stage 1 → final displayed rows

  // Stage 1 — everything except tag (for adaptive counts)
  ...
  // Adaptive tag counts — computed from preTagFiltered so chips reflect current filters
        ...
        <Table className="min-w-[900px]">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-[60px] text-center">Contenido</TableHead>
