...
export const WHATSAPP_TEMPLATES: WhatsAppTemplate[] = [
  ...
  },
  {
    ...
    language: 'es_CO',
    description: 'Confirmación de pedido con detalles de compra',
    previewText: 'Hola {{1}}! Recibimos tu pedido #{{2}}. Productos: {{3}}. Total: {{4}}. Dirección: {{5}}, {{6}}.',
    params: [
      { key: '1', label: 'Nombre del cliente', placeholder: 'Juan Pérez' },
      { key: '2', label: 'Número de pedido', placeholder: '1234' },
      { key: '3', label: 'Productos', placeholder: '2x Camiseta, 1x Pantalón' },
      { key: '4', label: 'Total', placeholder: 'COP 150,000' },
      { key: '5', label: 'Dirección', placeholder: 'Cra 45 #67-89' },
  ...
  },
  {
    ...
    previewText: 'Hola {{1}}! Pedido #{{2}}: tu ciudad es {{3}} pero el departamento dice {{5}}. ¿Debería ser {{4}}?',
    params: [
      { key: '1', label: 'Nombre del cliente', placeholder: 'Juan Pérez' },
      { key: '2', label: 'Número de pedido', placeholder: '1234' },
