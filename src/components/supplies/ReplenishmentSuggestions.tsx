              ...
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead
                    ...
                    title="Demanda a reponer por ventas (~40 días). 'Esta semana' = esta demanda + la cuota de reserva del plan que toca producir esta semana."
                  >
              ...
              <TableBody>
                {filteredSuggestions.map((suggestion) => (
                  <TableRow key={suggestion.variant_id}>
                    ...
                    <TableCell className="text-right">
                      {suggestion.this_week_target != null ? (
                        <div>
