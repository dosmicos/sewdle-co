...
const englishTranslations: Record<string, string> = {
  ...
  // Final CTA Section
  'finalCta.title': 'Ready to take control of your production?',
  'finalCta.subtitle': 'Free personalized demo, no-cost setup and dedicated support.',
  'finalCta.demo': 'Schedule demo',
  'finalCta.start': 'Get started now',
...
const spanishTranslations: Record<string, string> = {
  ...
  // Final CTA Section
  'finalCta.title': '¿Listo para tomar control de tu producción?',
  'finalCta.subtitle': 'Demo personalizada gratuita, configuración sin costo y soporte dedicado.',
  'finalCta.demo': 'Agendar demo',
  'finalCta.start': 'Empezar ahora',
