            ...
            if (change.field === 'messages') {
              ...
              for (const message of toArray(value.messages)) {
                ...
                if (exactChannel) {
                  ...
                  if (dosmicoChannel) {
                    console.log('Using fallback channel for default organization:', dosmicoChannel.id);
                    ...
                    console.log('Creating new WhatsApp fallback channel with phone_number_id:', phoneNumberId);
