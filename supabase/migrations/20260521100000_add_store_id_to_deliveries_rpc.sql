-- Agrega store_id al RPC get_deliveries_with_sync_status
-- orders ya tiene store_id (migración multi_store), solo lo exponemos en la función
...
AS $$
  ...
  GROUP BY d.id, o.order_number, o.store_id, w.name, p.name
