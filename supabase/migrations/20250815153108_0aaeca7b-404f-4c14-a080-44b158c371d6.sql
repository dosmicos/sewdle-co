-- Fix the suggested quantity calculation formula in replenishment suggestions
-- The formula should subtract open orders, not add them
...
BEGIN
  ...
  LOOP
    ...
    -- Pendientes = cantidad ordenada - cantidad aprobada para órdenes abiertas
    SELECT COALESCE(SUM(
    ...
    -- CORREGIDO: Cantidad sugerida = demanda proyectada - stock actual - pendientes
