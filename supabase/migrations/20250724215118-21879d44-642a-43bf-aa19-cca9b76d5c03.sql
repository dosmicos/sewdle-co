...
-- 1. Eliminar el trigger problemático existente
...
-- 2. Crear función mejorada que respeta el estado de la entrega
...
-- 3. Recrear el trigger con la lógica corregida
...
-- 4. LIMPIAR DATOS INCONSISTENTES: Resetear sincronización de items en entregas que están en revisión
...
-- 5. Actualizar función recalculate_delivery_sync_status para ser más estricta
...
-- 6. Actualizar estados de entregas que están en revisión para asegurar consistencia
UPDATE deliveries 
SET 
  synced_to_shopify = false,
  sync_error_message = NULL
