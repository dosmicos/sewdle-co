...
-- =====================================================
-- Fix: Lógica de reposición IA v2
--
-- Cambios respecto a versión anterior:
-- 1. Urgencia: productos P4 (solo histórico) → 'medium', no 'critical'
-- 2. Decaimiento: EXP(-0.025*días) reemplaza lineal con cap 30%
-- 3. Confianza: requiere ≥5 órdenes para 'high', no solo días con stock
-- 4. Entregas aprobadas no sincronizadas se cuentan como in_transit
-- 5. Protección contra división por cero en days_of_supply P4
-- =====================================================
...
BEGIN
  ...
  replenishment_calc AS (
    SELECT
      ...
      -- Velocidad ajustada con decaimiento exponencial para P4
      CASE
      ...
      -- Confianza de datos: combina días con stock + órdenes
      CASE
