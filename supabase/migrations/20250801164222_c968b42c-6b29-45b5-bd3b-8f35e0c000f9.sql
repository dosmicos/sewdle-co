...
SELECT 
  p.id as user_id,
  'cb497af2-3f29-4bb4-be53-91b7f19e5ffb' as organization_id, -- Demo Organization ID correcto
  CASE 
    -- Si el usuario tiene rol de Administrador, hacerlo admin
    WHEN EXISTS (
...
SET organization_id = 'cb497af2-3f29-4bb4-be53-91b7f19e5ffb'
