-- Fix PGRST203 error: Remove duplicate function definitions
-- Drop both versions of calculate_replenishment_suggestions to resolve overloading ambiguity
...
-- Create single definitive version with optional org_id parameter
