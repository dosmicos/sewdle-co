-- Corregir cálculo de días de stock (solo stock actual / velocidad diaria)
...
BEGIN
  ...
  SELECT
    ...
    -- CORREGIDO: Solo stock actual / velocidad diaria
    CASE 
    ...
    -- CORREGIDO: Urgencia basada en stock actual
    CASE
      ...
      ELSE 'low'
    END,
    -- CORREGIDO: Razón basada en stock actual
    CASE
