...
-- 8. Log de la corrección usando las columnas existentes
INSERT INTO sync_control_logs (sync_type, sync_mode, status, start_time, end_time, error_message)
VALUES (
  'delivery_sync_fix',
  'manual',
  'completed',
  now(),
  now(),
  'Corregida lógica de auto-sincronización para respetar estado de entregas en revisión'
);