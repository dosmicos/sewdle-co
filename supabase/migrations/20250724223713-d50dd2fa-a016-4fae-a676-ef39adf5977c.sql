-- Drop the problematic update_delivery_sync_status function completely
DROP FUNCTION IF EXISTS public.update_delivery_sync_status() CASCADE;

-- Now we can finally fix DEL-0047 without any interference
...
-- Create a completely new simple sync status function
