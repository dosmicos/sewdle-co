-- Corregir el cálculo de variant_age_days en calculate_replenishment_suggestions
...
BEGIN
  ...
  LOOP
    ...
    -- Calcular edad de la variante en días (CORRECCIÓN: cast directo en lugar de DATE_PART)
