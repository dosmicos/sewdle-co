-- Corregir TODAS las referencias a shopify_inventory en refresh_inventory_replenishment
-- Reemplazar con product_variants.stock_quantity que es donde realmente está el stock
