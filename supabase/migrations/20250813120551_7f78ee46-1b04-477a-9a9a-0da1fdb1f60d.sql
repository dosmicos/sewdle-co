-- Actualizar parámetros de reposición: Lead time 30 días, Safety days 10 días
-- Primero eliminar la función existente y recrearla con los nuevos valores
...
BEGIN
  ...
  RAISE NOTICE 'Cálculo de reposición completado con nuevos parámetros: lead time % días, safety % días', lead_time_days, safety_days;
END;
$function$;