-- Corrección completa: incluir todos los status activos y eliminar filtro de delivery
...
BEGIN
  ...
  -- CTE para calcular producción pendiente (CORREGIDO: incluye todos los status y todas las entregas)
