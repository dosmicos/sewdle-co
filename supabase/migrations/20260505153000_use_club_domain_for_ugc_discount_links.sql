-- Use club.dosmicos.com as the public UGC discount-link domain.
-- Existing redirect tokens remain unchanged; only the displayed/shareable host changes.
...
BEGIN
  ...
  SELECT jsonb_build_object(
    'id', dl.id,
    'public_url', 'https://club.dosmicos.com/ugc/' || dl.redirect_token,
