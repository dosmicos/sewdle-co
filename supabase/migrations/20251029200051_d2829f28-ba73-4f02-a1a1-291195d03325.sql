-- Fix type mismatch in refresh_inventory_replenishment function
-- Change JOIN from variant_id (bigint) = id (uuid) to sku (text) = sku_variant (text)
